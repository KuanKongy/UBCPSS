...
export const TEAM_MEMBERS: TeamMember[] = [
  // VP Admin
  { initials: 'JZ', name: 'Jackson Zhou',  role: 'VP Admin',               avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'NC', name: 'Nathan Chen',   role: 'VP Admin',               avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'CY', name: 'Cliff Yang',    role: 'VP Admin',               avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'ER', name: 'Eric',          role: 'VP Admin',               avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'LW', name: 'Lucie Wang',    role: 'VP Admin',               avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'CA', name: 'Catherina Y',   role: 'VP Admin',               avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'ME', name: 'Maddy E',       role: 'VP Admin',               avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'RO', name: 'Roger',         role: 'VP Admin',               avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'SH', name: 'Shamel',        role: 'VP Admin',               avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  // Social Media
  { initials: 'VR', name: 'Vrinda',        role: 'Social Media Director',  avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'AH', name: 'Aisha Hsu',     role: 'Social Media',           avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'JE', name: 'Jessica',       role: 'Social Media',           avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  // PR Committee
  { initials: 'HO', name: 'Howard',        role: 'PR Director',            avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'JQ', name: 'Jacquline',     role: 'PR Committee',           avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'JN', name: 'Jonathan',      role: 'PR Committee',           avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'KI', name: 'Kiran',         role: 'PR Committee',           avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  // Events Committee
  { initials: 'AS', name: 'Ashassavir',    role: 'Events Committee',       avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'NS', name: 'Nicole Sia',    role: 'Events Committee',       avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'CW', name: 'Clinton Wong',  role: 'Events Committee',       avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'JM', name: 'Jasmeet',       role: 'Events Committee',       avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'SM', name: 'Samuel',        role: 'Events Committee',       avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'EL', name: 'Elaine',        role: 'Events Committee',       avatarIndex: 1, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'AO', name: 'Ashley Or',     role: 'Events Committee',       avatarIndex: 2, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  { initials: 'BI', name: 'Bernard Ip',    role: 'Events Committee',       avatarIndex: 3, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
  // Software
  { initials: 'NL', name: 'Nam Le',        role: 'Software Developer',     avatarIndex: 0, linkedin: 'https://www.linkedin.com/in/kuankongy/' },
]
