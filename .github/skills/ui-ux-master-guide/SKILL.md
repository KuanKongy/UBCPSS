...
<img src="logo.png" alt="wep app - Social media scheduler" />
```
...
### Setup (Next.js)
```bash
npx create-next-app@latest wep app --typescript --tailwind --app
cd wep app
...
## 🎯 wep app-SPECIFIC DESIGN DECISIONS
...
- **Loom** — Video upload flow (great for wep app upload UX)
...
**STATUS:** ✅ Ready to build wep app with world-class UI/UX
